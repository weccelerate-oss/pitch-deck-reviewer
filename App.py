...
def analyze_slides(slides_data: list[dict], context_text: str, model_name: str = "gemini-3-pro-preview") -> list[dict]:
    """
...
"""
    ...
    status = st.empty()
    status.markdown(f"🔍 **מנתח {total} שקפים עם Gemini 3 Pro...**")
...
def main():
    ...
    with st.sidebar:
        ...
        model_desc = {
            "gemini-3-pro-preview": "🧠 **Gemini 3 Pro** - המודל החכם ביותר"
        }
